import { FraudDetectionResponse, RefusalResponse, FraudAnalysis, Transaction } from '@/lib/api';
...
export default function ResultsPanel({ result, transactions, isLoading, error }: ResultsPanelProps) {
  return (

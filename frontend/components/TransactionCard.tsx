  ...
  return (
    ...
    >
      ...
      <div className="p-5">
        ...
        {/* Expandable Details */}
        {showDetails && (
          <div className="mt-4 pt-4 border-t space-y-3 transition-all duration-300" style={{ borderColor: 'var(--border)' }}>
            {/* Transaction ID */}
            <div>
              <p className="text-xs mb-1" style={{ color: 'var(--text-tertiary)' }}>Transaction ID</p>
              <p className="text-xs font-mono p-2 rounded" style={{ color: 'var(--text-primary)', background: 'var(--surface-hover)' }}>
                {txn.id}
              </p>
            </div>
            ...
            {/* Temporal Features */}
            <div>
              <p className="text-xs text-navy-500 mb-2 font-semibold">Temporal Analysis</p>
            ...
            <div>
              ...
              <div className="bg-navy-100 p-3 rounded">
                ...
                <p className={`text-lg font-bold ${model_features.deviations.amt_diff_from_card_median_7d > 0
                  ? 'text-coral-600'
                  : 'text-emerald-600'
                  }`}>
